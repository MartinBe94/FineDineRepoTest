using FineDine.Database.Entities;
using Microsoft.EntityFrameworkCore;
using System.IO;
using static System.Net.WebRequestMethods;

namespace FineDine.Database.Context;
public class FineDineContext: DbContext
{
    ...
    public virtual DbSet<Drink> Drink { get; set; } = null!;

    public FineDineContext(DbContextOptions<FineDineContext> options) : base(options) { }
